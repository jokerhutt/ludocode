...
export function BuilderCourseCard({ title, id }: BuilderCourseCardProps) {
  ...
  return (
    <div className="w-full text-white rounded-2xl p-6 flex-col flex lg:flex-row lg:items-center lg:justify-between border-ludo-surface border-2">
      ...
      <Button
        ...
        onClick={() => router.navigate(adminNavigation.builder.toBuilder(id))}
      >
        Edit Course
      </Button>
    </div>
