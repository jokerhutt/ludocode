...
import { SUBMIT_AI_PROMPT } from "@/constants/api/pathConstants";
import type { ChatBotChatType } from "@/components/design-system/composites/chatbot/chatbot-window.tsx";
